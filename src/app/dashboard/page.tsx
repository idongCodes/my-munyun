          ...
          <div className="flex items-center gap-2">
            ...
            {status?.google_linked ? (
              <button
                type="button"
                onClick={() => {
                  setUnlinkEmail(status.email || '');
                  setUnlinkPassword('');
                  setUnlinkConfirmPassword('');
                  setShowUnlinkModal(true);
                }}
                className="text-[10px] font-bold py-1.5 px-3 rounded-lg border bg-emerald-500/10 text-emerald-400 border-emerald-500/20 hover:bg-red-950/20 hover:text-red-400 hover:border-red-500/20 transition-all cursor-pointer flex items-center gap-1.5"
                title="Google Account connected. Click to disconnect."
              >
              ...
              <button
                ...
                className="text-[10px] font-extrabold py-1.5 px-3 rounded-lg border bg-white text-zinc-900 border-zinc-200 hover:bg-zinc-100 transition-all cursor-pointer flex items-center gap-1.5"
              >
                <svg className="w-3.5 h-3.5 flex-shrink-0" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
